...
st.sidebar.title("GPCSSI 2022 TOOL")
from PIL import Image
image = Image.open('Haryana-police-logo.png')

st.image(image, caption='')
st.sidebar.title("")


image = Image.open('cyberpeace.png')
...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show analysis"):
        ...
        # Wordcloud
        st.title('Word Cloud')
        df_wc = helper.create_wordclopud(selected_user, df)
        fig, ax = plt.subplots()
        plt.imshow(df_wc)
        st.pyplot(fig)
